class FiveCardRanksInARowValidator():
    ...
    def _collections_of_five_straight_cards_in_a_row(self):
        index = 0                       # Index 0, [1, 2, 3, 4, 5], Index 1 [2, 3, 4, 5, 6], index 2 [3, 4, 5, 6, 10]
        ...
        while index + 4 <= final_index:
            ...
            if self._every_element_increments_by_one(next_five_rank_indices):
    ...
    def _every_element_increments_by_one(self, rank_indexes):
